...
fh = FSFileHandler(model_folder='logs/sample-self', robomaker_log_path='logs/v4-logs/logs/training/training-20240312030540-ACR2bF8iT7m3IMfDssxqfQ-robomaker.log')
log = DeepRacerLog(filehandler=fh)
